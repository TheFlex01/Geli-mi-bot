...
exports.run = (client, message, args) => {
  ...
  if (!modlog) return message.reply('`mod-log` kanalını bulamıyorum.<a:b_:509690009935282185> ');
  ...
  if (!message.guild.member(user).bannable) return message.reply('Yetkilileri banlayamam <a:b_:509690009935282185> .');
